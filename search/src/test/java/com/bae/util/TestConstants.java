...
public class TestConstants {
	...
	public static final Associate MOCK_ASSOCIATE_OBJECT3 = new Associate("name", "surname", "phonecalls", "latestPhoneCall", "123", "associateId");
	...
	public static final Citizen MOCK_CITIZEN_OBJECT3= new Citizen("id3", "user", "identification", "1", "somePlace", "QW12 QWE", "14", "male", "0123456789");
	...
	public static final SuspectCar MOCK_CAR_OBJECT3 = new SuspectCar("id", "name", "surname", "QW12 QWE", "make", "model", "colour");
